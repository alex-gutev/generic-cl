...
[[ITERATOR]] is the high-level function for creating iterators, whereas
[[MAKE-ITERATOR]] AND [[MAKE-REVERSE-ITERATOR]] are the generic functions to
...
indices of the sub-sequence to iterated over (see [[MAKE-ITERATOR]] and
[[MAKE-REVERSE-ITERATOR]] for more information).
...
end of the sequence are unspecified.
...
*Note:* This default ~T~ method calls ~CL:ENDP~ since this function
...
used by a few sequence operations.
