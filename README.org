...
mandatory and may modify accumulate items into a copy of ~SEQUENCE~
instead.
...
The sequence return might not be the same object passed to
~MAKE-COLLECTOR~.
...
Implementing this method as optional as default methods are provided
...
Methods:
   ...
   - ~T ITERATOR~
     ...
     The iterator is copied thus the position of the iterated passed
